...
Execução: O cógio pode ser executado em compiladores online ou editores instalados. Recomendação: Google Colab

Aviso: o código usa as bibliotecas MATH, OS e PANDAS Pandas: !pip install pandas
...
Caso encontre algum erro, contatar: elisamb@usp.br fernanda.formigoni@usp.br isabelysaito@usp.br
